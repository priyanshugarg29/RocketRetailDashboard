...
st.markdown("""Above session funnel chart shows how many customer visits make it through each step of the shopping process. Nearly all sessions start with people viewing products (over 1.7 million times). But far fewer take the next step that is only about 39,000 sessions end up with something added to the cart. Even fewer (about 11,000), actually lead to a completed purchase.
